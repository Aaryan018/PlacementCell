...
public class studentupdate extends javax.swing.JFrame {
    ...
    private void button1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button1ActionPerformed
        ...
        r=Integer.parseInt(t1.getText());
            ...
            if(rs.next())
            {
                ...
                t7.setText(""+rs.getDouble("tenth"));
                t8.setText(""+rs.getDouble("twelth"));
                t9.setText(""+rs.getDouble("graduation"));
    ...
    private void button2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button2ActionPerformed
        ...
        int r;
            ...
            String q="update tbstudent set fname=?,lname=?,email=?,contact=?,address=?,tenth=?,twelth=?,graduation=?,father=? where rno=? ";
            myConnection obj=new myConnection();
            PreparedStatement pst=obj.db.prepareStatement(q);
